...
"use strict";angular.module("showFlex").controller("downCtrl",["$scope","socketEvt","$rootScope","$http",function(n,o,t,a){n.files=[],n.loading=!0,n.changed=function(o){n.files=o},n.init=function(){a.get("/downloads").then(function(o){n.loading=!1,n.downloads=o.data})},n.init(),o.add("downloadsChanged",n.changed),t.$on("$stateChangeStart",function(t,a,d,e,l,i){"app.downloads"!==a.name&&o.remove("downloadsChanged",n.changed)})}]);
...
"use strict";angular.module("showFlex").controller("MainCtrl",["$scope","$mdSidenav","socketEvt","$interval","$http","$mdDialog",function(e,t,o,r,n,a){function s(e,t){e.cancel=function(){t.cancel()},e.add=function(){var o=e.addtoQueue;return isNaN(o.toepisode)&&"f"!==o.toepisode?void Materialize.toast("Sorry the to episode should be a number or 'f'",4e3,"red"):"f"!==o.toepisode&&parseInt(o.toepisode)<parseInt(o.fromepisode)?void Materialize.toast("The to episode should be greater or equals from episode",4e3,"red"):(e.addQueueProgress=!0,void n.post("/addToqueue",{keyword:o.name,season:o.season,from:o.fromepisode,to:o.toepisode}).then(function(o){return e.addQueueProgress=!1,o.data.status?void t.cancel():void Materialize.toast(o.data.error,4e3,"red")}))}}e.serverOn=!1,e.addQueueProgress=!1,$(".button-collapse").sideNav(),o.add("log",function(e){Materialize.toast(e.str,4e3,"white"!==e.color?e.color:"")}),o.emit("serverStat"),r(function(){o.emit("serverStat")},7e3),o.add("serverStat",function(t){localStorage.queueCount||(localStorage.queueCount=t.queueCount),parseInt(localStorage.queueCount)<t.queueCount?e.newItems=t.queueCount-parseInt(localStorage.queueCount):e.newItems=!1,e.serverOn=t.running}),e.sendReq=function(e){return n({method:"GET",url:e})},e.startServer=function(){e.serverOn?e.sendReq("/stop").then(function(e){o.emit("serverStat")}):e.sendReq("/start").then(function(e){o.emit("serverStat")})},e.showAddtoQueue=function(e){a.show({controller:["$scope","$mdDialog",s],templateUrl:"views/addtoQueue.html",parent:angular.element(document.body),targetEvent:e,clickOutsideToClose:!1})}}]);
angular.module("showFlex").controller("queueCtrl",["$scope","socketEvt","$rootScope","$http",function(e,t,n,u){e.queue=[],e.loading=!0,e.openMenu=function(e,t){e(t)},e.startFrom=function(n){var a=e.queue.filter(function(e){return e.done}),n=n-a.length;return u({method:"GET",url:"/start",params:{index:n}}).then(function(e){e.data.error&&Materialize.toast(e.data.error,4e3,"red"),t.emit("serverStat")})},e.changed=function(t){e.queue=t},e.deleteFromQueue=function(t,n,a){e.queue.splice(a,1),u.post("/queue",{name:n.name,season:n.season,episode:n.episode}).then(function(e){e.data.status&&Materialize.toast("Item has been deleted successfly",4e3,"green")})},e.stateWatcher=function(t){e.queue[t.queueIndex]&&(e.queue[t.queueIndex].noOptions=t.running)},e.init=function(){u.get("/queue").then(function(t){e.loading=!1,e.queue=t.data})},e.init(),t.add("queueChanged",e.changed),t.add("serverStat",e.stateWatcher),n.$on("$stateChangeStart",function(n,u,a,o,r,i){"app.queue"!==u.name&&(t.remove("queueChanged",e.changed),t.remove("serverStat",e.stateWatcher))})}]);
