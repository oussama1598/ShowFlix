...
"use strict";angular.module("showFlex").controller("downCtrl",["$scope","socketEvt","$rootScope","$http",function(o,e,n,d){o.files=[],o.loading=!0,o.changed=function(e){o.files=e},o.delete=function(o){d.delete("api/downloads",{code:o.code,providerCode:o.providerCode})},o.init=function(){d.get("api/downloads").then(function(e){o.loading=!1,o.files=e.data})},o.init(),e.add("downloadsChanged",o.changed),n.$on("$stateChangeStart",function(n,d){"app.downloads"!==d.name&&e.remove("downloadsChanged",o.changed)})}]);
