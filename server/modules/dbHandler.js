...
export default class DbHandler extends EventEmitter {
  ...
  update (find = {}, replaceWith = {}, path) {
    ...
    this.emitUpdate(path, 'updated', this.find(find, path).value()) // this param is the new value
  }
